...
class Gvh(object):
    ...
    def create_aw_var(self, var_name: str, data_type: type,
        ...
        """
        a = dsm.DSM(var_name, data_type, self.__n_sys, self.__pid, value, vt.ShareType.ALL_WRITE)
    ...
    def create_ar_var(self, var_name: str, data_type: type,
        ...
        """
        a = dsm.DSM(var_name, data_type, self.__n_sys, self.__pid, value, vt.ShareType.ALL_READ)
        if self.__dsm is None:
            self.__dsm = {}
        self.__dsm[var_name] = a
