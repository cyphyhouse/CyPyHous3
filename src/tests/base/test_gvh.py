...
class TestGvh(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.ac = AgentConfig(0, 3, "127.1.1.1", 2000, [2000], None, True, None, None, None)
        self.tgvh = Gvh(self.ac, self.mc)

    def test_mutex_handler(self):
        self.assertEqual(self.tgvh.mutex_handler, self.ac.mutex_handler, "testing mutex handler")
