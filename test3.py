...
a0 = AgentConfig(0, bots, "", rport=2001, plist=[2001,2002], mh=BaseMutexHandler, is_leader=False, mhargs=[False,0])
a1 = AgentConfig(1, bots, "", rport=2001, plist=[2001,2002], mh=BaseMutexHandler, is_leader=False, mhargs=[False,1])
a2 = AgentConfig(2, bots, "", rport=2002, plist=[2001,2002], mh=BaseMutexHandler, is_leader=True, mhargs=[True,2])
